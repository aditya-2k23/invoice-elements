        ...
        >
          <Column backgroundColor="#eff6ff" padding="12px">
            ...
            <Paragraph
              ...
              lineHeight="1.5"
            >
              Friendly notice: Your invoice from{" "}
              <strong>{invoice.company.name}</strong> is due on{" "}
              <strong>{invoice.dueDate}</strong>. Please review the details
              below.
            </Paragraph>
          </Column>
        </Row>
      ...
      >
        ...
        <Column padding="0px">
          ...
          <Paragraph
            ...
            textAlign="right"
          >
            <strong>Bank:</strong> {invoice.paymentMethod.bankName}
            <br />
            <strong>Account Name:</strong> {invoice.paymentMethod.accountName}
            <br />
            <strong>Account #:</strong> {invoice.paymentMethod.accountNumber}
            <br />
